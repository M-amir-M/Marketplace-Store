...
return [
	...
	'route' => 'sms-admin',
	// SMS.ir Api Key
	'api-key' => env('SMSIR-API-KEY','f6680ee7f8a36197e1460ee7'),
	// SMS.ir Secret Key
	'secret-key' => env('SMSIR-SECRET-KEY','A 7 7 7 m 9 6 i 8 5 r'),
	// Your sms.ir line number
	'line-number' => env('SMSIR-LINE-NUMBER','30004505002207'),
	// ======================================================================
